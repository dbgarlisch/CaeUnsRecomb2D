...
*/
#define ID_CaeUnsRecomb2D 999
{
    /*== CAEP_FORMATINFO FormatInfo */
    {   PWP_SITE_GROUPNAME,     /* const char *group */
        "Recombine2D",             /* const char *name */
        MAKEGUID(ID_CaeUnsRecomb2D),  /* PWP_UINT32 id */
    ...
    CaeUnsRecomb2DBCInfo,            /* CAEP_BCINFO* */
    ARRAYSIZE(CaeUnsRecomb2DBCInfo), /* PWP_UINT32 BCCnt */

    /*== CAEP_VCINFO*    pVCInfo;    -- array of format VCs or NULL */
    /*== PWP_UINT32      VCCnt;      -- # format VCs */
    CaeUnsRecomb2DVCInfo,            /* CAEP_VCINFO* pVCInfo */
    ARRAYSIZE(CaeUnsRecomb2DVCInfo), /* PWP_UINT32 VCCnt */

    /*== const char**    pFileExt;   -- array of valid file extensions */
    /*== PWP_UINT32      ExtCnt;     -- # valid file extensions */
    CaeUnsRecomb2DFileExt,            /* const char **pFileExt */
    ARRAYSIZE(CaeUnsRecomb2DFileExt), /* PWP_UINT32 ExtCnt */
